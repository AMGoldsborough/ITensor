...
// 5 bosons per site (maximum) with anti-pbc 
// filling n/l = 1/2
// Andrew Goldsborough 17/05/2014
//
#include "core.h"
#include "mpo.h"
...
//      cout << mu(i) << endl;
    ...
    // set t(1) to -t(1) to give the anti-periodic boundary
    t(1) = -t(1);
//    Print(t);
...
//    sweeps.maxm() = 10,20,50,100,200;
    ...
    //
    // Calculate b^d correlation functions
    //
...
//    double bdcorr;
//    
//    MPO bdcorrMPO = MPO(model); 
//    
//    //open file to write to
//    ofstream corrfile;
//    std::stringstream fnamestream;
//    fnamestream << "./bdcorr/" << N << "_" << tstr << "_" << tdis << "_" << Ustr << "_" << Udis << "_" << mustr << "_" << mudis << "_bdcorr.txt;
//
//    corrfile.open(fnamestream.str().c_str());
    ...
    fnamestreamee << "./ee/" << N << "_" << tstr << "_" << tdis << "_" << Ustr << "_" << Udis << "_" << mustr << "_" << mudis << "_" << seed << "_" << chimax << "_ee_5_apbc_half.txt";
    eefile.open(fnamestreamee.str().c_str());

    ofstream eespfile;
    std::stringstream fnamestreameesp;
    fnamestreameesp << "./eespec/" << N << "_" << tstr << "_" << tdis << "_" << Ustr << "_" << Udis << "_" << mustr << "_" << mudis << "_" << seed << "_" << chimax << "_eespec_5_apbc_half.txt";
