...
//      cout << mu(i) << endl;
    ...
    int Npart = 2*N; //number of particles, default is N (half filling)
...
//    sweeps.noise() = 1E-4,1E-6,1E-8,0.0;
    cout << sweeps;
    ...
    fnamestreamenergy << "./energy/" << N << "_" << tstr << "_" << tdis << "_" << Ustr << "_" << Udis << "_" << mustr << "_" << mudis << "_" << seed << "_" << chimax << "_energy_5_two.txt";
    ...
    fnamestreamn << "./nexpect/" << N << "_" << tstr << "_" << tdis << "_" << Ustr << "_" << Udis << "_" << mustr << "_" << mudis << "_" << seed << "_" << chimax << "_nexpect_5_two.txt";
    ...
    fnamestreambdb << "./bdbcorr/" << N << "_" << tstr << "_" << tdis << "_" << Ustr << "_" << Udis << "_" << mustr << "_" << mudis << "_" << seed << "_" << chimax << "_bdbcorr_5_two.txt";
    ...
    fnamestreamnn << "./nncorr/" << N << "_" << tstr << "_" << tdis << "_" << Ustr << "_" << Udis << "_" << mustr << "_" << mudis << "_" << seed << "_" << chimax << "_nncorr_5_two.txt";
    ...
    fnamestreamso << "./strorder/" << N << "_" << tstr << "_" << tdis << "_" << Ustr << "_" << Udis << "_" << mustr << "_" << mudis << "_" << seed << "_" << chimax << "_strorder_5_two.txt";
...
//            bdbcorr = psiphi(psi,bdbket);
            ...
            bdbfile << j << " " << i << " " << format("%.15e\n")%bdbcorr; //print to file
...
//            IQTensor L;
            ...
            nnfile << j << " " << i << " " << format("%.15e\n")%nncorr; //print to file
...
//            IQTensor L;
            ...
            sofile << j << " " << i << " " << format("%.15e\n")%strorder; //print to file
            }
        }
    ...
    fnamestreamee << "./ee/" << N << "_" << tstr << "_" << tdis << "_" << Ustr << "_" << Udis << "_" << mustr << "_" << mudis << "_" << seed << "_" << chimax << "_ee_5_two.txt";
    eefile.open(fnamestreamee.str().c_str());

    ofstream eespfile;
    std::stringstream fnamestreameesp;
    fnamestreameesp << "./eespec/" << N << "_" << tstr << "_" << tdis << "_" << Ustr << "_" << Udis << "_" << mustr << "_" << mudis << "_" << seed << "_" << chimax << "_eespec_5_two.txt";
