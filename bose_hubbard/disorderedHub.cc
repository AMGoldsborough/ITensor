// Disordered Hubbard model DMRG using ITensor
// Andrew Goldsborough 12/02/2014
//
#include "core.h"
#include "mpo.h"
#include "model/hubbard.h"
#include "hams/DisorderedHub.h"
...
//    sweeps.maxm() = 10,20,50,100,200;
    ...
    fnamestreamee << "./ee/" << N << "_" << tstr << "_" << tdis << "_" << Ustr << "_" << Udis << "_" << mustr << "_" << mudis << "_" << seed << "_" << chimax << "_ee_Hub.txt";
    eefile.open(fnamestreamee.str().c_str());

    ofstream eespfile;
    std::stringstream fnamestreameesp;
    fnamestreameesp << "./eespec/" << N << "_" << tstr << "_" << tdis << "_" << Ustr << "_" << Udis << "_" << mustr << "_" << mudis << "_" << seed << "_" << chimax << "_eespec_Hub.txt";
