...
//      cout << mu(i) << endl;
    ...
    int Npart = N/2; //number of particles, default is N (half filling)
...
//    sweeps.maxm() = 10,20,50,100,200;
    ...
    fnamestreamn << "./nexpect/" << N << "_" << tstr << "_" << tdis << "_" << Ustr << "_" << Udis << "_" << mustr << "_" << mudis << "_" << seed << "_" << chimax << "_nexpect_5_half.txt";
    ...
    fnamestreambdb << "./bdbcorr/" << N << "_" << tstr << "_" << tdis << "_" << Ustr << "_" << Udis << "_" << mustr << "_" << mudis << "_" << seed << "_" << chimax << "_bdbcorr_5_half.txt";
    ...
    fnamestreamnn << "./nncorr/" << N << "_" << tstr << "_" << tdis << "_" << Ustr << "_" << Udis << "_" << mustr << "_" << mudis << "_" << seed << "_" << chimax << "_nncorr_5_half.txt";
    ...
    fnamestreamso << "./strorder/" << N << "_" << tstr << "_" << tdis << "_" << Ustr << "_" << Udis << "_" << mustr << "_" << mudis << "_" << seed << "_" << chimax << "_strorder_5_half.txt";
...
//            IQTensor L;
    ...
    fnamestreamee << "./ee/" << N << "_" << tstr << "_" << tdis << "_" << Ustr << "_" << Udis << "_" << mustr << "_" << mudis << "_" << seed << "_" << chimax << "_ee_5_half.txt";
    eefile.open(fnamestreamee.str().c_str());

    ofstream eespfile;
    std::stringstream fnamestreameesp;
    fnamestreameesp << "./eespec/" << N << "_" << tstr << "_" << tdis << "_" << Ustr << "_" << Udis << "_" << mustr << "_" << mudis << "_" << seed << "_" << chimax << "_eespec_5_half.txt";
